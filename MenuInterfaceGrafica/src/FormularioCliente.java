...
public class FormularioCliente extends JDialog {
    ...
    public FormularioCliente() {
        ...
        String[] opcoesEstadoCivil = {"Solteiro", "Casado", "Viúvo", "Divorciado"};
        ...
        // WhatsApp
        ckWhatsapp = new JCheckBox("Aceita contato por WhatsApp");
        ckWhatsapp.setBounds(100, 200, 220, 25);
        ckWhatsapp.setForeground(corMarromEscuro);
        ckWhatsapp.setBackground(corFundo);
        add(ckWhatsapp);
        ...
        btSalvar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                dados.append("Nome: ").append(txNome.getText())
                        ...
                        .append("\nAceita WhatsApp: ").append(ckWhatsapp.isSelected() ? "Sim" : "Não")
